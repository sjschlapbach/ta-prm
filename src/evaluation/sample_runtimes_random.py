...
if __name__ == "__main__":
    ...
    # run the TA-PRM algorithm with increasing connectivity
    ...
    # re-run the TA-PRM algorithm with limited temporal precision
    for k in tqdm(range(min_connections, max_connections, step)):
        runtime, max_open, path_cost = ta_prm_random(
            plotting=False,
            samples=200,
    ...
    ax3_2.set_ylabel("Max Open List")
